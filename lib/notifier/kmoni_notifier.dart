...
import 'package:eqmonitor2/api/kmoni.dart';
import 'package:eqmonitor2/api/kmoni/kmoni_image_parser.dart';
import 'package:eqmonitor2/api/kmoni/kmoni_web_api_url_generators.dart';
...
class KMoniNotifier extends StateNotifier<KmoniModel> {
  KMoniNotifier()
      : super(
          KmoniModel(
            analyzedPoint: [],
